    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (this.state.init) {
            ...
            pairs
                ...
                .attr("cx", (d) => (d["killer_position_x"] / 1000 * 800 / 812.45))
                .attr("cy", (d) => (d["killer_position_y"] / 1000 * 800 / 810))
                .attr("fill", "#ff0000")
                .attr("opacity", "0.2")
                .attr('r', 1);
            ...
            pairs
                ...
                .attr("cx", (d) => (d["victim_position_x"] / 1000 * 800 / 812.45))
                .attr("cy", (d) => (d["victim_position_y"] / 1000 * 800 / 810))
                .attr("fill", "#008bff")
                .attr("opacity", "0.2")
                .attr('r', 1);
